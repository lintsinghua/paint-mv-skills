...
const SONG = {
  ...
  duration: 86.63,               // seconds; the last frame is ceil(duration * fps) - 1
  bpm: 90,                   // constant tempo of the beat grid
  offset: 0.641,                  // time of beat 0 in seconds; beats fall at offset + n * 60 / bpm
  wipes: [43.974],                  // chapter breaks that get a brush wipe (s)
